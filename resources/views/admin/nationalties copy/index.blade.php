    ...
    <div class="ibox box-primary">
        <div class="ibox-title">
            <div class="pull-right">
                ...
                <a href="{{url('admin/countries/create')}}" class="btn btn-primary">
                        ...
                        @foreach($records as $record)
                            <tr id="removable{{$record->id}}">
                                ...
                                <td class="text-center">
                                    {!! \App\MyHelper\Helper::toggleBooleanView($record , url('admin/country/toggle-boolean/'.$record->id.'/is_active'),'is_active') !!}
                                </td>
                                <td class="text-center"><a href="{{url('admin/countries/' . $record->id .'/edit')}}" class="btn btn-xs btn-success"><i class="fa fa-edit"></i></a></td>
                                <!-- <td class="text-center">
                                    <button
                                            id="{{$record->id}}"
