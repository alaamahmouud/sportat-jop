    ...
    <div class="ibox box-primary">
        <div class="ibox-title">
            <div class="pull-right">
                ...
                <a href="{{url('admin/details/create')}}" class="btn btn-primary">
                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach($records as $record)
                            <tr id="removable{{$record->id}}">
                                ...
                                <td>{{optional($record->details)->name}}</td>
                     <td>
                         ...
                         @endempty
                                ...
                                <td class="text-center"><a href="{{url('admin/details/' . $record->id .'/edit')}}" class="btn btn-xs btn-success"><i class="fa fa-edit"></i></a></td>
                                <td class="text-center">
                                    <button
                                            id="{{$record->id}}"
                                            data-token="{{ csrf_token() }}"
                                            data-route="{{url('admin/details/'.$record->id)}}"
                                            type="button"
